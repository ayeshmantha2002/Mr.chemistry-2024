    ...
    if (mysqli_num_rows($user_verification_result) == 1) {
        ...
        if ($user_status != 1) {
            ...
            if (isset($_POST['search'])) {
                ...
                $video = "SELECT * FROM videos WHERE `Catagory` = 'video' AND (`Title` LIKE '%{$searchID}%')";
                ...
                $video = "SELECT * FROM videos WHERE `Catagory` = '{$catagory}' AND `Lesson` = {$vd}";
            } else {
                header("location: index");
            }
...
<head>
    ...
    <title>Mr.ChemistrY - Videos</title>
        ...
        <div class="content">
            ...
            <div class="eventAlin">
                <div class="classListBack" style="transform: translateY(-50px); border-radius: 5px;">
                    <a href="video-classes">Video class</a>
                    <a href="paper-discussions">Paper Discussions</a>
                    <a href="tutes"> Tutes </a>
                    <a href="modle-papers"> Modle Papers </a>
                </div>
                <br>
